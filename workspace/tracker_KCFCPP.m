...
% error('Tracker not configured! Please edit the tracker_ECOHC.m file.'); % Remove this line after proper configuration
...
tracker_command = '/media/elab/sdd/mycodes/tracker/OpenTracker/kcf/vot_kcf.bin';
